...
public class DataFixers {
   ...
   private static void addFixers(final DataFixerBuilder fixerUpper, final FileFixerUpper.Builder fileFixerUpper) {
      ...
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (value) -> value == (double)48.0F ? (double)16.0F : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (value) -> value == (double)48.0F ? (double)16.0F : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (value) -> value == (double)48.0F ? (double)16.0F : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (value) -> value == (double)40.0F ? (double)16.0F : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (value) -> value == (double)16.0F ? (double)12.0F : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (value) -> value == (double)16.0F ? (double)24.0F : value));
