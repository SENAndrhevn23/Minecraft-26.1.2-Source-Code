...
public class AquaticPlacements {
   ...
   public static void bootstrap(final BootstrapContext<PlacedFeature> context) {
      ...
      PlacementUtils.register(context, KELP_COLD, kelp, NoiseBasedCountPlacement.of(120, (double)80.0F, (double)0.0F), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
      PlacementUtils.register(context, KELP_WARM, kelp, NoiseBasedCountPlacement.of(80, (double)80.0F, (double)0.0F), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
      PlacementUtils.register(context, WARM_OCEAN_VEGETATION, warmOceanVegetation, NoiseBasedCountPlacement.of(20, (double)400.0F, (double)0.0F), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
   }
}
