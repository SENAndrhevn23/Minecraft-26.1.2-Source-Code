...
public class VegetationPlacements {
   ...
   public static void bootstrap(final BootstrapContext<PlacedFeature> context) {
      ...
      PlacementUtils.register(context, BAMBOO, bambooSomePodzol, NoiseBasedCountPlacement.of(160, (double)80.0F, 0.3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
