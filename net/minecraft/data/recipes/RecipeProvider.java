   ...
   protected abstract static class Runner implements DataProvider {
      ...
      public final CompletableFuture<?> run(final CachedOutput cache) {
         return this.registries.thenCompose((registries) -> {
            ...
            Set<ResourceKey<Recipe<?>>> allRecipes = Sets.newHashSet();
            List<CompletableFuture<?>> tasks = new ArrayList();
            RecipeOutput recipeOutput = new RecipeOutput() {
               // $FF: synthetic field
               final Set val$allRecipes;
               // $FF: synthetic field
               final List val$tasks;
               // $FF: synthetic field
               final CachedOutput val$cache;
               // $FF: synthetic field
               final HolderLookup.Provider val$registries;
               // $FF: synthetic field
               final PackOutput.PathProvider val$recipePathProvider;
               // $FF: synthetic field
               final PackOutput.PathProvider val$advancementPathProvider;

               {
                  this.val$allRecipes = val$allRecipes;
                  this.val$tasks = val$tasks;
                  this.val$cache = val$cache;
                  this.val$registries = val$registries;
                  this.val$recipePathProvider = val$recipePathProvider;
                  this.val$advancementPathProvider = val$advancementPathProvider;
               ...
               private void saveRecipe(final ResourceKey<Recipe<?>> id, final Recipe<?> recipe) {
                  this.val$tasks.add(DataProvider.saveStable(this.val$cache, this.val$registries, Recipe.CODEC, recipe, this.val$recipePathProvider.json(id.identifier())));
               }

               private void saveAdvancement(final AdvancementHolder advancementHolder) {
                  this.val$tasks.add(DataProvider.saveStable(this.val$cache, this.val$registries, Advancement.CODEC, advancementHolder.value(), this.val$advancementPathProvider.json(advancementHolder.id())));
               }
            };
