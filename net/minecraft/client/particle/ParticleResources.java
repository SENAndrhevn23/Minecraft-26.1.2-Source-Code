...
public class ParticleResources implements PreparableReloadListener {
   ...
   private void registerProviders() {
      ...
      this.register(ParticleTypes.GUST_EMITTER_LARGE, new GustSeedParticle.Provider((double)3.0F, 7, 0));
      this.register(ParticleTypes.GUST_EMITTER_SMALL, new GustSeedParticle.Provider((double)1.0F, 3, 2));
