...
public class BabyLlamaModel extends LlamaModel {
   ...
   public static LayerDefinition createBodyLayer(final CubeDeformation g) {
      ...
      root.addOrReplaceChild("right_chest", CubeListBuilder.create().texOffs(45, 28).addBox(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, g), PartPose.offsetAndRotation(-8.5F, 4.0F, 3.0F, 0.0F, ((float)Math.PI / 2F), 0.0F));
      root.addOrReplaceChild("left_chest", CubeListBuilder.create().texOffs(45, 41).addBox(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, g), PartPose.offsetAndRotation(5.5F, 4.0F, 3.0F, 0.0F, ((float)Math.PI / 2F), 0.0F));
