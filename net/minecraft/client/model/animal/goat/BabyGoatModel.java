...
public class BabyGoatModel extends GoatModel {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      head.addOrReplaceChild("right_horn", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(0.0F, -4.5F, 0.0F, 1.0F, 2.0F, 1.0F).mirror(false), PartPose.offsetAndRotation(-1.5F, -1.5F, -1.0F, (-(float)Math.PI / 8F), 0.0F, 0.0F));
      head.addOrReplaceChild("left_horn", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(2.0F, -4.5F, 0.0F, 1.0F, 2.0F, 1.0F).mirror(false), PartPose.offsetAndRotation(-1.5F, -1.5F, -1.0F, (-(float)Math.PI / 8F), 0.0F, 0.0F));
   ...
   public void setupAnim(final GoatRenderState state) {
      ...
      if (state.rammingXHeadRot == 0.0F) {
         this.head.xRot = ((float)Math.PI / 8F);
      }
