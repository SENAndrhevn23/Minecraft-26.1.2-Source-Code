...
public class SoundManager extends SimplePreparableReloadListener<Preparations> {
   ...
   protected static class Preparations {
      ...
      private void handleRegistration(final Identifier eventLocation, final SoundEventRegistration soundEventRegistration) {
         ...
         for(Sound sound : soundEventRegistration.getSounds()) {
            ...
            switch (sound.getType()) {
               ...
               case SOUND_EVENT:
                  weighted = new Weighted<Sound>() {
                     // $FF: synthetic field
                     final Identifier val$soundLocation;
                     // $FF: synthetic field
                     ...
                     {
                        this.val$soundLocation = val$soundLocation;
                     ...
                     public int getWeight() {
                        WeighedSoundEvents registration = (WeighedSoundEvents)this.this$0.registry.get(this.val$soundLocation);
                     ...
                     public Sound getSound(final RandomSource random) {
                        ...
                        if (registration == null) {
                           ...
                           return new Sound(wrappedSound.getLocation(), new MultipliedFloats(new SampledFloat[]{wrappedSound.getVolume(), this.val$sound.getVolume()}), new MultipliedFloats(new SampledFloat[]{wrappedSound.getPitch(), this.val$sound.getPitch()}), this.val$sound.getWeight(), Sound.Type.FILE, wrappedSound.shouldStream() || this.val$sound.shouldStream(), wrappedSound.shouldPreload(), wrappedSound.getAttenuationDistance());
                        }
                     }
