   ...
   private static record Glyph(LineData contents, int left, int right) implements UnbakedGlyph {
      ...
      public GlyphInfo info() {
         return new GlyphInfo() {
            // $FF: synthetic field
            final UnihexProvider.Glyph this$0;
            ...
            public float getAdvance() {
               return (float)(this.this$0.width() / 2 + 1);
            }
      ...
      public BakedGlyph bake(final UnbakedGlyph.Stitcher stitcher) {
         return stitcher.stitch(this.info(), new GlyphBitmap() {
            ...
            public void upload(final int x, final int y, final GpuTexture texture) {
               IntBuffer targetBuffer = MemoryUtil.memAllocInt(this.this$0.width() * 16);
               UnihexProvider.unpackBitsToBytes(targetBuffer, this.this$0.contents, this.this$0.left, this.this$0.right);
               targetBuffer.rewind();
               RenderSystem.getDevice().createCommandEncoder().writeToTexture(texture, MemoryUtil.memByteBuffer(targetBuffer), NativeImage.Format.RGBA, 0, 0, x, y, this.this$0.width(), 16);
