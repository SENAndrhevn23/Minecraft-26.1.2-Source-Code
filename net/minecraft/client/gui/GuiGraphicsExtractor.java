      ...
      for(MapRenderState.MapDecorationRenderState decoration : mapRenderState.decorations) {
         if (decoration.renderOnFrame) {
            ...
            if (decoration.name != null) {
               ...
               this.guiRenderState.addText(new GuiTextRenderState(font, decoration.name.getVisualOrderText(), new Matrix3x2f(this.pose), 0, 0, -1, Integer.MIN_VALUE, false, false, this.scissorStack.peek()));
               this.pose.popMatrix();
            }
         }
      }
