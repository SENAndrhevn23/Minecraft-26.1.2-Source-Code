   ...
   public interface GlyphVisitor {
      static GlyphVisitor forMultiBufferSource(final MultiBufferSource bufferSource, final Matrix4fc pose, final DisplayMode displayMode, final int lightCoords) {
         return new GlyphVisitor() {
            // $FF: synthetic field
            final MultiBufferSource val$bufferSource;
            // $FF: synthetic field
            final Font.DisplayMode val$displayMode;
            // $FF: synthetic field
            final Matrix4fc val$pose;
            // $FF: synthetic field
            final int val$lightCoords;

            {
               this.val$bufferSource = val$bufferSource;
               this.val$displayMode = val$displayMode;
               this.val$pose = val$pose;
               this.val$lightCoords = val$lightCoords;
            }
            ...
            private void render(final TextRenderable glyph) {
               VertexConsumer buffer = this.val$bufferSource.getBuffer(glyph.renderType(this.val$displayMode));
               glyph.render(this.val$pose, buffer, this.val$lightCoords, false);
            }
         };
      }
