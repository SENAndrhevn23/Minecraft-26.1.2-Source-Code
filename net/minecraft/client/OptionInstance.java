...
public final class OptionInstance<T> {
   ...
   interface IntRangeBase extends SliderableValueSet<Integer> {
      ...
      default <R> SliderableValueSet<R> xmap(final IntFunction<? extends R> to, final ToIntFunction<? super R> from, final boolean discrete) {
         return new SliderableValueSet<R>() {
            // $FF: synthetic field
            final ToIntFunction val$from;
            // $FF: synthetic field
            final IntFunction val$to;
            // $FF: synthetic field
            final boolean val$discrete;
            // $FF: synthetic field
            final OptionInstance.IntRangeBase this$0;

            {
               this.val$from = val$from;
               this.val$to = val$to;
               this.val$discrete = val$discrete;
            ...
            public Optional<R> validateValue(final R value) {
               Optional var10000 = this.this$0.validateValue(this.val$from.applyAsInt(value));
               IntFunction var10001 = this.val$to;
               Objects.requireNonNull(var10001);
               return var10000.map(var10001::apply);
            }

            public double toSliderValue(final R value) {
               return this.this$0.toSliderValue(this.val$from.applyAsInt(value));
            }

            public Optional<R> next(final R current) {
               if (!this.val$discrete) {
                  return Optional.empty();
               } else {
                  int currentIndex = this.val$from.applyAsInt(current);
                  return Optional.of(this.val$to.apply((Integer)this.this$0.validateValue(currentIndex + 1).orElse(currentIndex)));
               }
            }
            ...
            public R fromSliderValue(final double slider) {
               return (R)this.val$to.apply(this.this$0.fromSliderValue(slider));
            }

            public Codec<R> codec() {
               Codec var10000 = this.this$0.codec();
               IntFunction var10001 = this.val$to;
               Objects.requireNonNull(var10001);
               Function var1 = var10001::apply;
               ToIntFunction var10002 = this.val$from;
   ...
   public static enum UnitDouble implements SliderableValueSet<Double> {
      ...
      public <R> SliderableValueSet<R> xmap(final DoubleFunction<? extends R> to, final ToDoubleFunction<? super R> from) {
         return new SliderableValueSet<R>() {
            // $FF: synthetic field
            final ToDoubleFunction val$from;
            // $FF: synthetic field
            final DoubleFunction val$to;
            // $FF: synthetic field
            final OptionInstance.UnitDouble this$0;
            ...
            public Optional<R> validateValue(final R value) {
               Optional var10000 = this.this$0.validateValue(this.val$from.applyAsDouble(value));
               DoubleFunction var10001 = this.val$to;
               Objects.requireNonNull(var10001);
               return var10000.map(var10001::apply);
            }

            public double toSliderValue(final R value) {
               return this.this$0.toSliderValue(this.val$from.applyAsDouble(value));
            }
            ...
            public Codec<R> codec() {
               ...
               Objects.requireNonNull(var10001);
               Function var1 = var10001::apply;
               ToDoubleFunction var10002 = this.val$from;
               Objects.requireNonNull(var10002);
