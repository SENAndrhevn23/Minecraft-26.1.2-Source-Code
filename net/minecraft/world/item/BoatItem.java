...
public class BoatItem extends Item {
   ...
   public InteractionResult use(final Level level, final Player player, final InteractionHand hand) {
      ...
      if (hitResult.getType() == HitResult.Type.MISS) {
         ...
         List<Entity> entities = level.getEntities(player, player.getBoundingBox().expandTowards(viewVector.scale((double)5.0F)).inflate((double)1.0F), EntitySelector.CAN_BE_PICKED);
         if (!entities.isEmpty()) {
