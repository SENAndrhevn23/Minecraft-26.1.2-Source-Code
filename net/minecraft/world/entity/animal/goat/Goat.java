...
public class Goat extends Animal {
   ...
   protected void ageBoundaryReached() {
      this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(this.isBaby() ? (double)1.0F : (double)2.0F);
   }
   ...
   public float getRammingXHeadRot() {
      ...
      return (float)this.lowerHeadTick / 20.0F * maxRammingXHeadRot * ((float)Math.PI / 180F);
   }
