...
public class EnderChestBlockEntity extends BlockEntity implements LidBlockEntity {
   ...
   private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
      ...
      protected void onOpen(final Level level, final BlockPos pos, final BlockState blockState) {
         level.playSound((Entity)null, (double)pos.getX() + (double)0.5F, (double)pos.getY() + (double)0.5F, (double)pos.getZ() + (double)0.5F, SoundEvents.ENDER_CHEST_OPEN, SoundSource.BLOCKS, 0.5F, level.getRandom().nextFloat() * 0.1F + 0.9F);
      }

      protected void onClose(final Level level, final BlockPos pos, final BlockState blockState) {
         level.playSound((Entity)null, (double)pos.getX() + (double)0.5F, (double)pos.getY() + (double)0.5F, (double)pos.getZ() + (double)0.5F, SoundEvents.ENDER_CHEST_CLOSE, SoundSource.BLOCKS, 0.5F, level.getRandom().nextFloat() * 0.1F + 0.9F);
      }
