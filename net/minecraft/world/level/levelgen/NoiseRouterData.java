...
public class NoiseRouterData {
   ...
   protected static NoiseRouter nether(final HolderGetter<DensityFunction> functions, final HolderGetter<NormalNoise.NoiseParameters> noises) {
      DensityFunction temperature = DensityFunctions.shiftedNoise2d(DensityFunctions.zero(), DensityFunctions.zero(), (double)0.25F, noises.getOrThrow(Noises.TEMPERATURE_NETHER));
      DensityFunction vegetation = DensityFunctions.shiftedNoise2d(DensityFunctions.zero(), DensityFunctions.zero(), (double)0.25F, noises.getOrThrow(Noises.VEGETATION_NETHER));
