...
public final class NbtUtils {
   ...
   private static final Comparator<ListTag> YXZ_LISTTAG_DOUBLE_COMPARATOR = Comparator.comparingDouble((list) -> list.getDoubleOr(1, (double)0.0F)).thenComparingDouble((list) -> list.getDoubleOr(0, (double)0.0F)).thenComparingDouble((list) -> list.getDoubleOr(2, (double)0.0F));
